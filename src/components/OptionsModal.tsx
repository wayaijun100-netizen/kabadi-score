...
import { ScoreboardSettings, KeyBindings } from '../types';
...
export const OptionsModal: React.FC<OptionsModalProps> = ({
  ...
  const [activeTab, setActiveTab] = useState<'teams' | 'text' | 'layout' | 'keys' | 'match' | 'desktop'>('teams');
                ...
                <div className="space-y-6">
                  ...
                  <div className="p-5 rounded-2xl bg-black/40 border border-white/10 space-y-4">
                    ...
                    <div className="p-4 rounded-xl bg-[#080c14] border border-white/10 grid grid-cols-1 md:grid-cols-2 gap-4 items-center">
                      ...
                      >
                        <div
                          className="font-display font-black uppercase tracking-widest text-center truncate w-full text-transparent bg-clip-text bg-gradient-to-r from-white via-slate-200 to-white"
